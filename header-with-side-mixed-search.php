            ...
            <div class="side-search-wrap">
                ...
                <div class="mixed-search-panel mixed-search-side-banner">
                    <ul class="nav nav-tabs">
                        <li class="nav-item  ">
                            <a class="nav-link active" aria-current="active" data-bs-target="#nightly-search-panel" role="tab" data-bs-toggle="tab">Nightly</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="nightly-search-panel">                            

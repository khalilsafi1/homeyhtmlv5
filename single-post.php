                        ...
                        <div class="article-main">
                            <article class="single-blog-article block">
                                ...
                                <div class="post-featured-image">
                                    <img src="img/750x422.png" alt="Blog Image" width="750" height="422">
                                </div>
                                ...
                                <div class="prev-box float-start text-left">
                                    <a class="hover-effect" href="#">
                                        <div class="next-prev-block-content">
                                            <p>Prev Post</p>
                                            <p><strong>This is a post title</strong></p>
                                        </div>
                            ...
                            <div class="blog-section block">
                                ...
                                <ul class="comments-list list-unstyled">
                                    <?php include ('inc/blog/comment.php'); ?>
                                    <?php include ('inc/blog/comment-reply.php'); ?>
                                    <?php include ('inc/blog/comment.php'); ?>
                                </ul>

<article class="blog-article block">
	...
	<div class="block-footer clearfix">
		...
		<a href="single-post.php" class="btn btn-primary btn-sm-full-width float-end px-4">Read More</a>
	</div>
</article>
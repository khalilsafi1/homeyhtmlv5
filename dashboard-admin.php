                            ...
                            <div class="dashboard-area admin-top-banner">
                                ...
                                <div class="block">
                                    <div class="block-verify">
                                        ...
                                        <div class="block-col block-col-33 text-left">
                                            <h3>Experience</h3>
                                            <p class="block-big-text">25</p>
                                            <div>2 New experiences</div>
                                            <a class="btn btn-success-outlined btn-slim admin-top-banner-btn" href="#">Manage</a>
                                        </div>
                                        <div class="block-col block-col-33">
                                            <h3>Reservations</h3>
                                ...
                                <div class="block">
                                    ...
                                    <div class="table-block dashboard-listing-table dashboard-table">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php include 'inc/dashboard/dashboard-admin-experience-item-pending.php';?>
                                            </tbody>
                                        </table>
                                    </div>
                                </div><!-- .block -->
                                ...
                                <div class="block">
                                    ...
                                    <div class="table-block dashboard-reservation-table dashboard-table">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php include 'inc/dashboard/dashboard-reservation-experiences-admin.php';?>
                                            </tbody>
                                        </table>
                                    </div>
                                </div><!-- .block -->
